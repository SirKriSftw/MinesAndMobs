...
data merge storage mines_and_mobs:default {spell: {range:10.0f, speed:2.0f, is_hitscan:1b}}
data merge storage mines_and_mobs:default {spell: {p_mobs:0b, p_blocks:0b, bounce:0b, chain:0b}} 
