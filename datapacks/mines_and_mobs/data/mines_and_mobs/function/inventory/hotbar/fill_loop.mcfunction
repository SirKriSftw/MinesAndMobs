...
$execute unless items entity @s hotbar.$(current_hotbar_slot) * \
  run item replace entity @s hotbar.$(current_hotbar_slot) with light_gray_stained_glass_pane[custom_data={filler:1b}]
