# Calculate Cast Time ---
execute store result score @s skillCastTime run data get entity @s SelectedItem.components."minecraft:custom_data".cast
...
# Calculate Cooldown ---
execute store result score @s skillCooldowns run data get entity @s SelectedItem.components."minecraft:custom_data".cooldown
