data merge storage mines_and_mobs:default {skill: {id: 0}}
data merge storage mines_and_mobs:default {skill: {name: "Generic Skill"}}
data merge storage mines_and_mobs:default {skill: {cast: 0.1, cooldown: 1.0}}
data merge storage mines_and_mobs:default {skill: {animation: "bow"}}
