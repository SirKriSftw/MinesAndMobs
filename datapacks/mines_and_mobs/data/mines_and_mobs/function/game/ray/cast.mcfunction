...
$data modify entity @e[tag=ray_worker,limit=1,distance=..1] data set value {range:$(range), p_mobs:$(p_mobs), p_blocks:$(p_blocks), bounce:$(bounce), hit_mob:0b, hit_block: 0b}
