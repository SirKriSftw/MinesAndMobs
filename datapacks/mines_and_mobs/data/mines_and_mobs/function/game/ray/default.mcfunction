data merge storage mines_and_mobs:default {use: {range:10.0f, speed:1.0f}}
...
data merge storage mines_and_mobs:default {use: {end_particle: "minecraft:smoke", end_particle_data: "0 0 0 0 0 0 force"}}
